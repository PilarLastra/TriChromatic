...
public class TransitionScreen extends AbstractScreen{
    ...
    private Screeen.transition.Transition outTransition;
    private Screeen.transition.Transition inTransition;
    ...
    public void startTransition(AbstractScreen from, AbstractScreen to, Screeen.transition.Transition out, Transition in) {
        this.from = from;
        this.to = to;
